...
This project incorporates strict database constraints and business logic tailored with a unique Malagasy cultural theme (featuring Ariary currency `Ar`, traditional dishes like *Romazava*, and local ingredients).
